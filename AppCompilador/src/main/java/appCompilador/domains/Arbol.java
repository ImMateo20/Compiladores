...
public class Arbol {
    ...
    public Nodo crearArbol(List<Token> tokens) {
        ...
        if (indice == -1)
            throw new ErrorCompiladorException("No se encontro operador aritmetico");
    ...
    private boolean esParentesis(List<Token> tokens, int ini, int fin) {
        ...
        if (!stack.isEmpty())
            throw new ErrorCompiladorException("No se encontro el parentesis de cierre");
    ...
    public int obtenIndice(List<Token> tokens, int ini, int fin) {
        ...
        for (int i = ini; i < fin; i++) {
            ...
            if (lexema.equals("(")) {
                ...
                throw new ErrorCompiladorException("No se encontro el parentesis de apertura");
            }
